...
ActiveRecord::Schema.define(version: 20150210095921) do
  ...
  add_index "firmwares", ["version", "channel"], name: "index_firmwares_on_version_and_channel", unique: true, using: :btree
